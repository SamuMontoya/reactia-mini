...
export default function GatekeepingPage() {
  ...
  const diagonalPattern = `repeating-linear-gradient(45deg, var(--color-dust) 0, var(--color-dust) 1px, transparent 1px, transparent 40px)`;
      ...
      <div className="grid h-full w-full lg:grid-cols-[1fr_2fr]">
        ...
        >
          ...
          <div
            ...
            style={{ backgroundImage: diagonalPattern, backgroundSize: '56px 56px' }}
          />
          {/* Amber halo */}
          <div
            className="ds-halo left-1/2 top-[-18rem] h-[32rem] w-[32rem] -translate-x-1/2"
            style={{ background: amberHalo }}
          />
          ...
          <div className="relative z-10 mx-auto max-w-md text-left">
            ...
            <p
              className="ds-animate-up mt-3 text-lg text-dust"
